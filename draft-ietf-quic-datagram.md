...
As DATAGRAM frames are inherently unreliable, a receiver can drop a DATAGRAM
frame if an application cannot process the contents of the frame; see {{ack}}.
